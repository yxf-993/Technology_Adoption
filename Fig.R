...
# Thermal comfort indexes comparison by income level over three years
# May 25
...
#                                            '$100K to 150K',
#                                            '$150K or more'))
# save(DF, file = "~/Desktop/2022-Technology reduce insecurity/R&R_2/Data/Figure3_0525.Rdata")
...
ggplot(HP_2019, aes(x = factor(VINCOME), y = CBP, fill = factor(HP))) +
  ...
  theme_minimal() +  
  labs(x = "Income Group", y = "Cooling Balance Point (°C)", title = "(a) Year 2019") +
  theme_bw(base_size = 14, base_family = "Arial") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
...
ggsave("Fig_3a.png", width = 8, height = 6, dpi = 900, units = "in", type = "cairo-png")
...
ggplot(HP_2019, aes(x = factor(VINCOME), y = S3, fill = factor(HP))) +
  ...
  stat_summary(fun = median, geom = "text", aes(label = sprintf("%.2f", ..y..)), 
               vjust = -0.5, color = "black", position = position_dodge(width = 0.8)) +
  theme_minimal() +  
  labs(x = "Income Group", y = "Cooling Slope (kWh/°C)", title = "(b) Year 2019") +
  theme_bw(base_size = 14, base_family = "Arial") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = c(0.15, 0.8),
        legend.background = element_rect(fill = "transparent", colour = NA),
...
ggsave("Fig_3b.png", width = 8, height = 6, dpi = 900, units = "in", type = "cairo-png")
...
ggplot(HP_2020, aes(x = factor(VINCOME), y = CBP, fill = factor(HP))) +
  ...
  stat_summary(fun = median, geom = "text", aes(label = sprintf("%.2f", ..y..)), 
               vjust = -0.5, color = "black", position = position_dodge(width = 0.8)) +
  theme_minimal() +  
  labs(x = "Income Group", y = "Cooling Balance Point (°C)", title = "(c) Year 2020") +
  theme_bw(base_size = 14, base_family = "Arial") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = c(0.15, 0.08),
        legend.background = element_rect(fill = "transparent", colour = NA),
...
ggsave("Fig_3c.png", width = 8, height = 6, dpi = 900, units = "in", type = "cairo-png")
...
ggplot(HP_2020, aes(x = factor(VINCOME), y = S3, fill = factor(HP))) +
  ...
  stat_summary(fun = median, geom = "text", aes(label = sprintf("%.2f", ..y..)), 
               vjust = -0.5, color = "black", position = position_dodge(width = 0.8)) +
  theme_minimal() +  
  labs(x = "Income Group", y = "Cooling Slope (kWh/°C)", title = "(d) Year 2020") +
  theme_bw(base_size = 14, base_family = "Arial") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = c(0.15, 0.8),
        legend.background = element_rect(fill = "transparent", colour = NA),
...
ggsave("Fig_3d.png", width = 8, height = 6, dpi = 900, units = "in", type = "cairo-png")
...
ggplot(HP_2021, aes(x = factor(VINCOME), y = CBP, fill = factor(HP))) +
  ...
  stat_summary(fun = median, geom = "text", aes(label = sprintf("%.2f", ..y..)), 
               vjust = -0.5, color = "black", position = position_dodge(width = 0.8)) +
  theme_minimal() +  
  labs(x = "Income Group", y = "Cooling Balance Point (°C)", title = "(e) Year 2021") +
  theme_bw(base_size = 14, base_family = "Arial") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = c(0.15, 0.08),
        legend.background = element_rect(fill = "transparent", colour = NA),
...
ggsave("Fig_3e.png", width = 8, height = 6, dpi = 900, units = "in", type = "cairo-png")
...
ggplot(HP_2021, aes(x = factor(VINCOME), y = S3, fill = factor(HP))) +
  ...
  stat_summary(fun = median, geom = "text", aes(label = sprintf("%.2f", ..y..)), 
               vjust = -0.5, color = "black", position = position_dodge(width = 0.8)) +
  theme_minimal() +  
  labs(x = "Income Group", y = "Cooling Slope (kWh/°C)", title = "(f) Year 2021") +
  theme_bw(base_size = 14, base_family = "Arial") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = c(0.15, 0.8),
        legend.background = element_rect(fill = "transparent", colour = NA),
...
ggsave("Fig_3f.png", width = 8, height = 6, dpi = 900, units = "in", type = "cairo-png")
...
reg_results$FacetGroup <- ifelse(reg_results$Variable == "Heat Pump", "Main", "Controls")
reg_results$FacetGroup <- factor(reg_results$FacetGroup, levels = c("Main", "Controls"))

ggplot(reg_results, aes(x = Coefficient, y = Variable, color = Outcome)) +
  ...
  facet_wrap(~ FacetGroup, ncol = 1, scales = "free") +  # ncol = 1 for vertical layout
  labs(title = "Heat Pump Effects") +
  theme_minimal() +
  theme_bw(base_size = 14, base_family = "Arial") +
  theme(
    legend.background = element_rect(fill = "transparent", colour = NA),
...
ggsave("Fig_4.png", width = 10, height = 6, dpi = 900, units = "in", type = "cairo-png")
...
ggsave(final_plot, file = "Fig_11.png", width = 10, height = 10, dpi = 900, units = "in", type = "cairo-png")
...
mean_by_account <- combined_df %>%
  group_by(BILACCT_K, Group) %>%
  summarise(mean_elesum = mean(elesum, na.rm = TRUE), .groups = 'drop')
t.test(mean_elesum ~ Group, data = mean_by_account)
cohen.d(mean_elesum ~ Group, data = mean_by_account)


excluded <- mean_by_account %>%
  group_by(BILACCT_K) %>%
  filter(all(Group == "Full Sample")) %>%
  ungroup()
excluded <- excluded %>%
  mutate(Group = "Excluded")

subset <- mean_by_account %>%
  filter(Group == "Subset")

Dset <- bind_rows(mean_by_account, excluded) %>%
  arrange(BILACCT_K, Group)

summary_table <- Dset %>%
  group_by(Group) %>%
  summarise(
    count = n(),                        
    mean = mean(mean_elesum, na.rm = TRUE),   
    sd = sd(mean_elesum, na.rm = TRUE),       
    min = min(mean_elesum, na.rm = TRUE),    
    Q1 = quantile(mean_elesum, 0.25, na.rm = TRUE),  
    median = median(mean_elesum, na.rm = TRUE),      
    Q3 = quantile(mean_elesum, 0.75, na.rm = TRUE), 
    max = max(mean_elesum, na.rm = TRUE)      
  )

excluded_subset <- Dset %>% filter(Group %in% c("Excluded", "Subset"))
t.test(mean_elesum ~ Group, data = excluded_subset)
cohen.d(mean_elesum ~ Group, data = excluded_subset)
